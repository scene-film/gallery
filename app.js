...
const CONFIG = {
    GAS_URL: 'https://script.google.com/macros/s/AKfycbzOwFLchZo1KlMVmiaDjLdQoH5rtbyjoll0Ub1d1ZBHJoU18T3XbK_JY0ZOUq3Jz5RMDw/exec'
};
...
async function submitVideo() {
    ...
    try {
        if (currentUploadType === 'dropbox') {
            ...
            const payload = { action: 'uploadAndSave', fileBase64: fileBase64, fileName: selectedFile.name, mimeType: selectedFile.type, title, description: features, category, thumbnail: thumbnailToSend };
